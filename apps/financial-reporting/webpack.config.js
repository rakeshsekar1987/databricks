...
module.exports = (env, argv) => {
  ...
  return {
    ...
    output: {
      publicPath: isDevelopment ? 'http://localhost:3002/' : 'auto',
    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        exposes: {
          './App': './src/App',
          './FinancialGrid': './src/components/FinancialGrid',
        },
        shared: {
          ...
          // AG Grid v30 - NOT shared as singleton
      ...
      new HtmlWebpackPlugin({
        ...
        title: 'Financial Reporting - Standalone',
      }),
    ],
  };
};
