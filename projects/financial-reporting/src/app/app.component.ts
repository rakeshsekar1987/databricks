...
@Component({
  ...
  template: `
    <div class="financial-reporting-standalone">
      <header class="standalone-header">
        <h1>Financial Reporting Module</h1>
        <span class="version-badge">AG Grid v30</span>
      </header>
      <main><router-outlet></router-outlet></main>
    </div>
  `,
  styles: [`
    .financial-reporting-standalone { min-height: 100vh; background: #f5f5f5; }
    .standalone-header {
