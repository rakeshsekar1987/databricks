...
@Component({
  ...
  styles: [`
    ...
    .module-header {
      ...
      color: white; border-radius: 8px; margin-bottom: 24px;
    }
...
export class EntryComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log('[FinancialReporting] Module loaded - AG Grid v30.2.0');
  }
  
  setActiveTab(tab: 'statements' | 'analysis' | 'reports'): void {
